...
---@param pid number @The player ID.
---@param attributeId number @The attribute ID.
---@return number
...
---@param pid number @The player ID.
---@param state number @Whether the player is male.
...
---@param pid number @The player ID.
---@param value number @The new level of the player.
function api.SetLevel(pid, value) end

---Set the player's progress to their next character level.
---@param pid number @The player ID.
---@param value number @The new level progress of the player.
...
---@param pid number @The player ID.
---@param attributeId number @The attribute ID.
---@param value number @The new base value of the player's attribute.
...
---@param pid number @The player ID.
---@param skillId number @The skill ID.
---@param value number @The new base value of the player's skill.
...
---@param pid number @The player ID.
---@param attributeId number
---@param value number @The increase in the attribute caused by skills.
function api.SetSkillIncrease(pid, attributeId, value) end

---Set the bounty of a player.
---@param pid number @The player ID.
---@param value number @The new bounty.
...
---@param pid number @The player ID.
---@param currentStage number @The new current stage.
---@param endStage number @The new ending stage.

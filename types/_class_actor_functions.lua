...
---@param pid number @The player ID to whom the actor list should be attached.
...
---@param action number @The new action.
...
---@param refNum number @The refNum of the target object.
---@param mpNum number @The mpNum of the target object.
...
---@param duration number @The duration of the package.

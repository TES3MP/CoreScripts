...
---@param pid number @The player ID whose topic changes should be used.
...
---@param pid number @The player ID whose topic changes should be used.
---@param index number @The index of the topic.
---@return string
...
---@param pid number @The player ID of the character playing the animation.
---@param groupname string @The groupname of the animation.
---@param mode number @The mode of the animation.
---@param count number @The number of times the animation should be played.
...
---@param pid number @The player ID of the character playing the sound.

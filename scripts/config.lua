...
"faggot", "fellatio", "fuck", "gas the ", "Hitler", "nigga", "nigger", "smegma", "vagina", "whore", "Malseph", "terrabyte25", "terabyte25", "Trap", "ты гей", "Soy", "Bitch", "Daddy", "Nazi", "Socialis", "race war", "Retard", "Rape", "Kas Gikes" }

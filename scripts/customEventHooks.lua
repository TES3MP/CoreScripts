...
---@alias OnActorDeathCallback fun(eventStatus: EventStatus, pid: integer, cellDescription: string, actors: table<string, ActorPacket>)
---@alias OnActorEquipmentCallback fun(eventStatus: EventStatus, pid: integer, cellDescription: string, actors: table<string, ActorPacket>)
---@alias OnActorListCallback fun(eventStatus: EventStatus, pid: integer, cellDescription: string, actors: table<string, ActorPacket>)
---@alias OnActorSpellsActiveCallback fun(eventStatus: EventStatus, pid: integer, cellDescription: string, actors: table<string, ActorPacket>)
...
---@alias OnConsoleCommandCallback fun(eventStatus: EventStatus, pid: integer, cellDescription: string, objects: ObjectObjectPacket[], targetPlayers: ObjectPlayerPacket[])
---@alias OnContainerCallback fun(eventStatus: EventStatus, pid: integer, cellDescription: string, objects: ObjectObjectPacket[])

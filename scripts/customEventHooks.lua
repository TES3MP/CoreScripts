...
---@alias OnConsoleCommandCallback fun(eventStatus: EventStatus, pid: integer, cellDescription: string, objects: table<string, ObjectObjectPacket>, targetPlayers: ObjectPlayerPacket[])
...
---@alias OnObjectActivateCallback fun(eventStatus: EventStatus, pid: integer, cellDescription: string, objects: table<string, ObjectActivateObjectPacket>, players: ObjectActivatePlayerPacket[])
...
---@alias OnObjectHitCallback fun(eventStatus: EventStatus, pid: integer, cellDescription: string, objects: table<string, ObjectHitObjectPacket>, players: ObjectHitPlayerPacket[])
...
---@alias OnObjectSoundCallback fun(eventStatus: EventStatus, pid: integer, cellDescription: string, objects: table<string, ObjectSoundObjectPacket>, players: ObjectSoundPlayerPacket[])
